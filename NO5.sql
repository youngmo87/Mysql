CREATE TABLE `grade` (
  ...
  `midterm` int(11) unsigned NOT NULL DEFAULT '0',
  `finalterm` int(11) unsigned NOT NULL DEFAULT '0',
  `enroll` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `fk_student_grade_idx` (`enroll`),
  CONSTRAINT `fk_student_grade` FOREIGN KEY (`enroll`) REFERENCES `Enroll` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
